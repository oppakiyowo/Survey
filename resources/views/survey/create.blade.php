                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-6">
                                        <div class="form-group">
                                            <label for="village">Nama Kelurahan <span class="required-label">*</span>
                                            </label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small id="rt" class="form-text text-muted">Isi dengan RT yang di survey
                                                (contoh : 001).</small>
                                            @error('rt')
                                            <td>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="rw"
                                                class="form-control  @error('rw') is-invalid @enderror" id="rt" id="rw">
                                            <small id="rw" class="form-text text-muted">Isi dengan RW yang di survey
                                                (contoh : 001).</small>
                                            @error('rw')
                                            <td>
                                                <p class="text-danger">{{$message}}</p>
                                    ...
                                    <div class="col-md-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <small id="pindah" class="form-text text-muted">Isi dengan jumlah penduduk
                                                yang pindah.</small>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small id="meningga" class="form-text text-muted">Isi dengan jumlah penduduk
                                         ...
                                         <div class="form-group">
                                            ...
                                            <small id="ganda" class="form-text text-muted">Isi dengan jumlah penduduk
                                                data ganda.</small>
                                        </div>
                ...
                <div class="col-6 col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="tanggal_survey ">Tanggal Survey <span
                                        class="required-label">*</span></label>
                                <input type="date" class="form-control  @error('rw') is-invalid @enderror"
                                    name="tanggal_survey" id="published_at" value="{{ old('tanggal_survey') }}">
